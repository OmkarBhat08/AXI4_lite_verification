    ...
    begin
      ...
      begin
        ...
        fork : arready_wait
          ...
          begin
            repeat(timeout) @(vif.drv_cb); 
            `uvm_fatal("TIMEOUT", "Deadlock: Slave never asserted ARREADY")
          end
        join_any
        disable arready_wait; 
  ...
  task check_rd_data();
    ...
    begin
      ...
      fork : rvalid_wait
        ...
        begin
          repeat(timeout) @(vif.drv_cb);
          `uvm_fatal("TIMEOUT", "Deadlock: Slave never asserted RVALID")
        end
      join_any
      disable rvalid_wait;
    ...
    begin
      ...
      begin
        ...
        fork : awready_wait
          ...
          begin
            repeat(timeout) @(vif.drv_cb);
            `uvm_fatal("TIMEOUT", "Deadlock: Slave never asserted AWREADY")
          end
        join_any
        disable awready_wait;
    ...
    begin
      ...
      begin
        ...
        fork : wready_wait
          ...
          begin
            repeat(timeout) @(vif.drv_cb);
            `uvm_fatal("TIMEOUT", "Deadlock: Slave never asserted WREADY")
          end
        join_any
        disable wready_wait;
  ...
  task check_wrt_resp();
    ...
    begin
      ...
      fork : bvalid_wait
        ...
        begin
          repeat(timeout) @(vif.drv_cb);
          `uvm_fatal("TIMEOUT", "Deadlock: Slave never asserted BVALID")
        end
      join_any
      disable bvalid_wait;
